...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    { url: 'https://www.freelanceflow.com.br/blog/como-fazer-proposta-comercial', lastModified: new Date() },
    { url: 'https://www.freelanceflow.com.br/blog/como-precificar-servicos-freelancer', lastModified: new Date() },
    { url: 'https://www.freelanceflow.com.br/blog/como-fazer-follow-up-proposta', lastModified: new Date() },
    { url: 'https://www.freelanceflow.com.br/blog/contrato-freelancer-modelo', lastModified: new Date() },
