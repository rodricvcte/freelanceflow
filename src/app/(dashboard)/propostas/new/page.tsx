        ...
        <div className="bg-white border border-gray-100 rounded-xl p-6 shadow-sm space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="flex flex-col">
              ...
              <input type="number" min="1" value={form.deadline_days} onChange={e => setField('deadline_days', e.target.value)} placeholder="Ex: 30 dias" className={inputCls + ' mt-auto'} />
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="flex flex-col">
              ...
              <input type="date" value={form.valid_until} onChange={e => setField('valid_until', e.target.value)} min={todayMin} placeholder="dd/mm/aaaa" className={inputCls + ' mt-auto'} />
            </div>
            <div className="flex flex-col">
              <label className={labelCls}>Condições de pagamento</label>
              <input type="text" value={form.payment_terms} onChange={e => setField('payment_terms', e.target.value)} placeholder="Ex: 50% antecipado" className={inputCls + ' mt-auto'} />
            </div>
          </div>
        </div>
